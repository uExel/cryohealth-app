...
## Corpus Check
- 70 files · ~79,358 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 481 nodes · 915 edges · 59 communities (20 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `60ff7e0f`
...
Cohesion: 0.12
Nodes (45): expo-router, AlertDetail(), ObservedAlertDetail, NewCase(), OUTCOMES, PROBLEMS, Critical(), Guidance() (+37 more)

### Community 1 - "theme.ts"
Cohesion: 0.07
Nodes (27): react, react, Signup(), TabBarProps, TABS, UExTabBar(), bannerFor(), border (+19 more)

### Community 2 - "home.tsx"
Cohesion: 0.07
Nodes (44): Alerts(), toCardData(), byRank(), TIER_RANK, FILTERS, TIER_RANK, AlertCard(), AlertCardData (+36 more)

### Community 3 - "expo"
Cohesion: 0.06
Nodes (31): backgroundColor, backgroundImage, foregroundImage, monochromeImage, adaptiveIcon, predictiveBackGestureEnabled, projectId, reactCompiler (+23 more)

### Community 4 - "sync.ts"
Cohesion: 0.09
Nodes (29): plugins, expo-secure-store, Splash(), AppEffects(), ApiError, apiFetch(), ApiFetchOptions, ApiAlert (+21 more)
...
### Community 6 - "include"
Cohesion: 0.14
Nodes (13): ./assets/*, expo-env.d.ts, expo/tsconfig.base, .expo/types/**/*.ts, **/*.ts, **/*.tsx, compilerOptions, experimentalDecorators (+5 more)
...
### Community 19 - "HANDOFF — cryohealth-app — 2026-08-08 21:15 PKT"
Cohesion: 0.17
...
## Knowledge Gaps
- **222 isolated node(s):** `check-gstack.sh script`, `name`, `slug`, `version`, `orientation` (+217 more)
...
- **Should `useStyles` be split into smaller, more focused modules?**
  _Cohesion score 0.12211538461538461 - nodes in this community are weakly interconnected._
